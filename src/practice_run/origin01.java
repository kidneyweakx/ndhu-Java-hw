...
public class origin01 extends Frame implements Runnable{
	Image im,im2;int x=0,dx=10;Thread th;
	origin01(){
	...
	public void paint(Graphics g){
		...
		g.drawImage(im2, 250, 280, 100, 150, this);
	}
	...
	public static void main (String[] a){ origin01 mm = new origin01();}
